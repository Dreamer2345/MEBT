...
if (play.inv[a] = 3) and (play.inv[b] = 0) or (play.inv[a] = 0) and (play.inv[b] = 3) then
		begin
		play.inv[b]:=1;
		play.inv[a]:=12;
		sve:=1;
...
if (play.inv[a] = 7) and (play.inv[b] = 12) or (play.inv[a] = 12) and (play.inv[b] = 7) then
		begin
		play.inv[b]:=1;
		play.inv[a]:=13;
		sve:=1;
...
if (play.inv[a] = 16) and (play.inv[b] = 0) or (play.inv[a] = 0) and (play.inv[b] = 16) then
		begin
		play.inv[b]:=1;
		play.inv[a]:=18;
		sve:=1;
...
if (play.inv[a] = 16) and (play.inv[b] = 18) or (play.inv[a] = 18) and (play.inv[b] = 16) then		
		begin
		play.inv[b]:=19;
		play.inv[a]:=18;
		sve:=1;
...
if (play.inv[a] = 19) and (play.inv[b] = 0) or (play.inv[a] = 0) and (play.inv[b] = 19) then		
		begin
		play.inv[b]:=7;
		play.inv[a]:=1;
		sve:=1;
