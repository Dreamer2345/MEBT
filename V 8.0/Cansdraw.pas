...
{ADDED:03/09/17}
{AUTHOR:Thomas Buckland}	
{FUNCTION:Checks if a cordinate is equal to another}
...
{ADDED:03/09/17}
{AUTHOR:Thomas Buckland}	
{FUNCTION:Adds frameskipping capability}
...
{ADDED:03/09/17}
{AUTHOR:Thomas Buckland}	
{FUNCTION:Creates a fancy boxon screen with different side and corners}
...
{ADDED:03/09/17}
{AUTHOR:Thomas Buckland}	
{FUNCTION:Applies a 2D rotation to a  set of cordinates (0-360)}
